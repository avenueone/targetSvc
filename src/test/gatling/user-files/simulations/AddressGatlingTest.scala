...
class AddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .get("/targetsvc/api/addresses")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new address")
            .post("/targetsvc/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "street":"SAMPLE_TEXT"
                , "region":"SAMPLE_TEXT"
                , "locality":"SAMPLE_TEXT"
                , "country":"SAMPLE_TEXT"
                , "postOfficeLocator":"SAMPLE_TEXT"
                , "email":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/targetsvc${new_address_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created address")
            .delete("/targetsvc${new_address_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
